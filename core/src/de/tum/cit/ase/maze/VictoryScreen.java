...
import com.badlogic.gdx.utils.viewport.Viewport;
    ...
    public class VictoryScreen implements Screen {
         ...
         */
        public VictoryScreen(MazeRunnerGame game, float delta, int hearts) {
            ...
            table.add(new Label("Score: " + (int) (hearts * 3000 - delta * 5), game.getSkin(), "title")).padBottom(80).row();
            table.setBackground(new TextureRegionDrawable(new Texture("victory screen.jpg")));
